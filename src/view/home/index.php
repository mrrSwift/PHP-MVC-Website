    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading">What is This site?</h2>
                <hr class="dark my-4">
                <p class="text-faded mb-4">This site is a project to get a php diploma on the w3schools site and it was written by me, Amirshayan Zarei, with love and passion. I hope this site will be approved by the experts of this site You can find the rest of my projects from my github page at the below </p> <a href="https://github.com/amirzarei007">Github</a>
            </div>
        </div>
    </div>
</section>
